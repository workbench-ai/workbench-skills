...
description: >-
  ...
  starters or the bundled skill, author or validate workflow YAML, start or
...
- Do not overwrite an existing template install or skill install unless the user explicitly asked to replace it.
